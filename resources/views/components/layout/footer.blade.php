@php
    ...
    $waLocal = \Illuminate\Support\Str::startsWith($waDigits, '55') ? substr($waDigits, 2) : $waDigits;
    $waDisplay = strlen($waLocal) >= 10
        ? '(' . substr($waLocal, 0, 2) . ') ' . substr($waLocal, 2, strlen($waLocal) - 6) . '-' . substr($waLocal, -4)
        : $whatsapp;

    $cnpj = app(\App\Settings\GeneralSettings::class)->cnpj;
@endphp
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-2.5 text-sm">
                        <li><a href="#servicos"
                                class="text-slate-500 hover:text-brand-600 transition-colors">Serviços</a></li>
                        <li><a href="#cases" class="text-slate-500 hover:text-brand-600 transition-colors">Cases</a>
                        </li>
                        <li><a href="#valores" class="text-slate-500 hover:text-brand-600 transition-colors">Valores</a>
                        </li>
                        <li><a href="#planos" class="text-slate-500 hover:text-brand-600 transition-colors">Áreas de
                                atuação</a></li>
                        <li><a href="#faq" class="text-slate-500 hover:text-brand-600 transition-colors">Perguntas
                                frequentes</a></li>
                    </ul>
                </div>
                        ...
                        <li>
                            <a class="flex items-center gap-2.5 text-slate-500 hover:text-brand-600 transition-colors"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                    ...
                                    stroke-linejoin="round" class="w-4 h-4 text-brand-600 flex-shrink-0">
                                    <path
