...
@php    
    $class = match($index) {
        '0' => 'objective-item-first',
        '1' => 'objective-item-second',
        '2' => 'objective-item-third',
    };
@endphp

@if ($name && $description)
    <div
    class="objective-item {{  $class }}">
        ...
        <div
            ...
            <div>
                <svg class="objective-item-icon" xmlns="http://www.w3.org/2000/svg"
