<section class="py-20 px-4 sm:px-6 lg:px-8" id="como-funciona">
    ...
    <div class="max-w-7xl mx-auto">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mt-10">
                            ...
                            <div
                                ...
                                <svg class="w-8 h-8 fill-blue-400" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="grid grid-cols-3 gap-x-6 mt-10">
            ...
            <div
                ...
                <div
                    ...
                    <div>
                        <svg class="w-5 h-5 fill-blue-400" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 640 640"><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                            <path
                    ...
                    <div class="leading-relaxed border-t border-slate-800 text-sm text-gray-300 pb-5 px-6 ">
                        ...
                        <ul>
                            <li class="flex items-start gap-2">
                                <span class="plan-detail-item-list-item-pointer">•</span>
                                <span class="text-gray-300">
                                    O site é desenvolvido com qualidade e atenção total
                                </span>
                            </li>
                            ...
                            <li class="flex items-start gap-2">
                                <span class="plan-detail-item-list-item-pointer">•</span>
                                <span class="text-gray-300">
                                    Os custos ficam claros (o que é desenvolvimento e o que é manutenção)
                                </span>
                            </li>
            ...
            <div
                ...
                <div
                    ...
                    <div>
                        <svg class="w-5 h-5 fill-purple-400" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 640 640"><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                            <path
                                d="M560.3 301.2C570.7 313 588.6 315.6 602.1 306.7C616.8 296.9 620.8 277 611 262.3L563 190.3C560.2 186.1 556.4 182.6 551.9 180.1L351.4 68.7C332.1 58 308.6 58 289.2 68.7L88.8 180C83.4 183 79.1 187.4 76.2 192.8L27.7 282.7C15.1 306.1 23.9 335.2 47.3 347.8L80.3 365.5L80.3 418.8C80.3 441.8 92.7 463.1 112.7 474.5L288.7 574.2C308.3 585.3 332.2 585.3 351.8 574.2L527.8 474.5C547.9 463.1 560.2 441.9 560.2 418.8L560.2 301.3zM320.3 291.4L170.2 208L320.3 124.6L470.4 208L320.3 291.4zM278.8 341.6L257.5 387.8L91.7 299L117.1 251.8L278.8 341.6z" />
                        </svg>
                    ...
                    <div class=" text-gray-300 leading-relaxed border-t border-slate-800 text-sm pt-4 pb-5 px-6">
                        ...
                        <ul>
                            <li class="flex items-start gap-2">
                                <span class="plan-detail-item-list-item-pointer">•</span>
                                <span class="text-gray-300">
                                    O desenvolvimento do site acontece antes da contratação do plano mensal
                                </span>
                            </li>
                            ...
                            <li class="flex items-start gap-2">
                                <span class="plan-detail-item-list-item-pointer">•</span>
                                <span class="text-gray-300">
                                    O plano mensal é responsável pela continuidade, suporte e evolução
                                </span>
                            </li>
                            ...
                            <li class="flex items-start gap-2">
                                <span class="plan-detail-item-list-item-pointer">•</span>
                                <span class="text-gray-300">
                                    Não trabalhamos com contratos confusos ou taxas escondidas
                                </span>
                            </li>
            ...
            <div
                ...
                <div
                    ...
                    <div>
                        <svg class="w-5 h-5 fill-yellow-400" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 640 640"><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                            <path
                                d="M560.3 301.2C570.7 313 588.6 315.6 602.1 306.7C616.8 296.9 620.8 277 611 262.3L563 190.3C560.2 186.1 556.4 182.6 551.9 180.1L351.4 68.7C332.1 58 308.6 58 289.2 68.7L88.8 180C83.4 183 79.1 187.4 76.2 192.8L27.7 282.7C15.1 306.1 23.9 335.2 47.3 347.8L80.3 365.5L80.3 418.8C80.3 441.8 92.7 463.1 112.7 474.5L288.7 574.2C308.3 585.3 332.2 585.3 351.8 574.2L527.8 474.5C547.9 463.1 560.2 441.9 560.2 418.8L560.2 301.3zM320.3 291.4L170.2 208L320.3 124.6L470.4 208L320.3 291.4zM278.8 341.6L257.5 387.8L91.7 299L117.1 251.8L278.8 341.6z" />
                        </svg>
