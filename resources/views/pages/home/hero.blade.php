        ...
        <div class="flex justify-center mb-6">
            <div
                ...
                <span class="text-sm text-purple-300">
                    Soluções digitais para o Reino
                </span>
            </div>
        </div>

        <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold text-center text-white mb-6">
            Leve sua igreja para o
            <span class="block text-purple-400 mt-2">
                Mundo Digital
            </span>
        </h1>

        <p class="max-w-3xl text-lg sm:text-xl text-gray-300 mx-auto mb-12">A
            Single Temas oferece tudo que sua congregação precisa: site moderno, gestão de membros, agenda de
            eventos e pedidos de oração. Conecte-se com seus fiéis onde eles estiverem.
        </p>
